...
#. use the search functionality `here <https://github.com/narenas/golf_project/issues>`__ to see if someone already filed the same issue;
...
#. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the Golf Project repository on GitHub;
